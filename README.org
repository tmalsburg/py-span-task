...
- [[https://github.com/tmalsburg/py-span-task/tree/master/GermanOperationSpan][English operation span task with consonants as targets]] (contributed by Cyrus Shaoul)
