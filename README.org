...
** News
- March 03, 2019: ::
  - Added three test batteries for Czech (contributed by Jan Chromý).
- July 14, 2017: ::
...
- [[https://github.com/tmalsburg/py-span-task/tree/master/CzechOperationSpan][Czech operation span task with consonants as targets]] (contributed by Jan Chromý)
- [[https://github.com/tmalsburg/py-span-task/tree/master/CzechReadingSpanLetters][Czech reading span task with consonants as targets]] (contributed by Jan Chromý)
- [[https://github.com/tmalsburg/py-span-task/tree/master/CzechReadingSpanWords][Czech reading span task with words as targers]] (contributed by Jan Chromý)
