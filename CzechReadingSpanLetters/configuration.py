...
target_items_file = "target_consonants.txt"
...
dávají smysl, a zapamatovat si přitom písmena, která se vám budou zobrazovat po přečtení každé z vět.
...
objeví nějaké písmeno. Vaším úkolem bude si tato písmena zapamatovat.
Po několika větách se zobrazí symbol otazníku a Vaším úkolem bude
napsat všechna písmena, která se mezi větami objevila, a to přesně v pořadí,
jako se objevila.

To, co napíšete, uvidíte v dolním řádku. 
Jednotlivá písmena oddělujte mezerami a až budete hotovi, zmáčkněte 
klávesu Enter. Vyvarujte se překlepů a raději si po sobě písmena 
ještě jednou přečtěte, jestli jsou napsána správně. 
Je jedno, jestli písmena uvádíte jako velká nebo malá.
...
Pro pokračování stiskněte mezerník."""
target_request = """Uveďte všechna písmena, která se objevila mezi větami, na která si vzpomínáte."""
